...
CREATE TABLE PAYMENT(
  ...
  TOTAL NUMBER(10) CHECK(TOTAL > 0)
)


CREATE  TABLE PAYMENT_DETAIL 
(
   MNO NUMBER(10) REFERENCES PAYMENT(MNO),
   PNO NUMBER(10) REFERENCES PRODUCT(PNO),
   AMOUNT NUMBER(10) NOT NULL,
   PRICE NUMBER(10) NOT NULL,
   TOTAL_PRICE NUMBER(10) NOT NULL CHECK(TOTAL_PRICE > 0),
