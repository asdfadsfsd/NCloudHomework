...
CREATE TABLE SCORE_CHK(
	...
	CNO VARCHAR2(8),
	RESULT NUMBER(3,0), 
	CONSTRAINT CHECK_RESULT CHECK(RESULT BETWEEN 60 AND 90)
);
...
--3) COURSE 테이블과 동일한 구조를 갖는 COURSE_CONSTRAINT 테이블을 생성하면서 CNO, CNAME을 PK로 PNO은 PROFESSOR_PK의 PNO을 참조하여
