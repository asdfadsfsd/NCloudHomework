...
public enum FoodOfCountry {
	...
	private FoodOfCountry(String country, String foodName) {
	...
	public void notifyFood(String country) {
		FoodOfCountry[] foodCountry = FoodOfCountry.values();
		
		for(FoodOfCountry fC : foodCountry) {
			if((fC.getCountry()).equals(country)) {
				System.out.println(fC.getCountry() + "의 대표음식은 " + fC.getFoodName() + "입니다.");
			} 
		}
