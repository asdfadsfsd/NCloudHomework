...
//	totalPrice(int optionOrder, int normalOrder) 옵션 추가 잔수와 일반 메뉴 잔수를 받아서 
//	각 메뉴의 가격을 계산하는 추상 메소드 구현한다. 
//	아아 2잔 뜨아 1잔 아라 1잔 휘핑 모카 2잔 콜드브루 2잔일 때의 가격을 출력하세요.
	public static void main(String[] args) {
		...
		Cafe coldbrew = Cafe.COLDBREW;
		
		System.out.println((americano.totalPrice(2, 1) + latte.totalPrice(1, 0) + 
							mocha.totalPrice(2, 0) + coldbrew.totalPrice(0, 2)));
	}
