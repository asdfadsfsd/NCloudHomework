...
//	maxOrMinOrMid라는 메소드를 갖는 함수형 인터페이스 MaxMinMid를 만들고 람다식으로 IntArrUtils의 메소드를 참조하여 구현하세요.
	public static void main(String[] args) {
		...
		System.out.println(start(IntArrUtils::getMax));
		System.out.println(start(IntArrUtils::getMid));
		System.out.println(start(IntArrUtils::getMin));
	}
	
	public static Number start(MaxMinMid maxMinMid) {
...
//		
//		sc.close();
		return maxMinMid.maxOrMinOrMid(numArr);
	}
